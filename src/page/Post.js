...
function Post({tema}){
    ...
    useEffect(() => {
        console.log(slug)
        axios.get("https://api.fostiums.org/post/"+slug.params.slug)
            .then(res => {
        ...
        <div className="container">
            ...
            <div className="row">
                ...
                <div className="col-md-8 col-md-offset-2 col-xs-12">
                    <div className="mainheading">
                        ...
                        <div className="row post-top-meta">
                            {/*<div className="col-md-2" >
                                <a href="#"><img className="author-thumb"
                                                           src={Ava}
                                                           alt="Sal"/></a>
                            </div>*/}
                            <div className="col-md-10">
                                <a style={tema=="dark"?{color:"white"}:null} className="link-dark" href="author.html">
                                    {post.penulis}
                                </a>
                                <a style={tema==="dark"?{color:"white"}:null} href="#" className="btn follow">{post.kategori}</a>
                                <span
                                    className="author-description"></span>
                                <br/>
                                <span style={tema==="dark"?{color:"white"}:null} className="post-date">{post.updated_at}</span>
                            </div>
                        </div>
                    ...
                    <img className="featured-image img-fluid" src={`https://api.fostiums.org/images/blog/${post.featured_img}`} alt={post.title}/>

                        <div className="article-post">

                            <td style={tema==="dark"?{color:"white"}:null} dangerouslySetInnerHTML={{__html: post.post}} />
                        </div>
